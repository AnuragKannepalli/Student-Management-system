...
def login():
    ...
    elif usernameEntry.get()=='Anurag' and passwordEntry.get()=='1234':
...
usernameLabel=Label(loginFrame,image=usernameImage,
...
passwordLabel=Label(loginFrame,image=passwordImage,
...
loginButton=Button(loginFrame,text='Login',font=('times new roman',14,'bold'),
                   ...
                   activebackground='cornflowerblue',cursor='hand2',
                   command=login)
